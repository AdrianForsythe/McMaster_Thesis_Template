...
%
% Modified to McMaster format by Benjamin Furman (http://www.xenben.com)
%
% License:
...
\renewbibmacro{in:}{\ifentrytype{article}{}{\printtext{\bibstring{in}\intitlepunct}}} % this remove the "In: Journal Name" from articles in the bibliography
